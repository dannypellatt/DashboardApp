...
const HeroSection = () => {
  return (
    <div className="bg-black w-screen flex items-center justify-center grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-2">
      ...
      <div className="p-0 md:p-12 text-left md:m-10">
        <h1 className="text-6xl md:text-8xl font-semibold text-white ">
          <span className="pulsate">D</span>anny
        </h1>
        <h1 className="text-6xl md:text-8xl font-semibold text-white mb-2">
      ...
      <div className="text-2xl md:text-3xl text-white font-normal m-8">
        <h2 className='py-12'>I build accessible and engaging digital platforms that delight users and drive business growth.</h2>
